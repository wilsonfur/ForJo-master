...
@IBDesignable
public class SwiftySwitch2: UIImageView {
    
    private var ball: SwitchBall!
    internal var delegate: SwiftySwitch2Delegate?
    ...
    @IBInspectable public var dotOffImage: UIColor = UIColor(red: 0/255, green: 66/255, blue: 99/255, alpha: 0.001) {
        didSet {
            config()
        }
    }
    @IBInspectable public var dotOnColor: UIColor = UIColor(red: 0/255, green: 199/255, blue: 170/255, alpha: 0.001) {
        didSet {
            config()
        }
    }
    @IBInspectable public var smallDotColor: UIColor = UIColor(red: 227/255, green: 49/255, blue: 67/255, alpha: 0) {
        didSet {
            config()
        }
    }
...
//        self.backgroundColor = myColor
        self.image = UIImage(named: "5minW")
        self.layer.cornerRadius = myFrame.height * corners0to1
        var oldBall = ball
        ball = SwitchBall(dotOnColor, dotOffImage, smallDotColor, isOn, myFrame, dotSpacer, smallDot0to1, dotTime)
...
protocol SwiftySwitch2Delegate {
    func valueChanged(sender: SwiftySwitch2)
}
